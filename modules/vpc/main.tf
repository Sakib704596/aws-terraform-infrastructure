...
# count creates one subnet per AZ
resource "aws_subnet" "public" {
  ...
  # Instances in public subnet get public IP
...
# Public Route Table
# Rules for public subnet traffic
...
# Private Route Table
# Rules for private subnet traffic
resource "aws_route_table" "private" {
  vpc_id = aws_vpc.main.id

  # Send internet traffic through NAT Gateway
  route {
    cidr_block     = "0.0.0.0/0"
